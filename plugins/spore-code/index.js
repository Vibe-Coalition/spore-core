...
function buildProjectContextSection(api, opts) {
  ...
  parts.push('Security block rule: if an install or credential operation is blocked by a tool, do not route around it with curl/manual package downloads, alternate package managers, vendored code, or expect/pexpect/sshpass password scripts. Stop, report the exact blocker, and ask for a safer package, key-based credential setup, sidecar/saved-host config, or manual operator action.');
