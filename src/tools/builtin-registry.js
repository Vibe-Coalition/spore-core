...
function buildBuiltinToolHandlers(tools) {
  return {
    ...
    workflow_status: () => tools._workflowStatusTool(),
    sessions_list: () => tools._sessionsListTool(),
    settings_read: input => tools._settingsReadTool(input),
    request_planner_advice: input => tools._requestPlannerAdviceTool(input),
    ...
    spore_list: input => tools._sporeListTool(input),
    spore_message: input => tools._sporeMessageTool(input),
    spore_graph: input => tools._sporeGraphTool(input),
    spore_manage: input => tools._sporeManageTool(input),
