...
const PORTABLE_SETTINGS_ENV = {
  ...
  learnerActivationMode: 'SPORE_LEARNER_ACTIVATION_MODE',
  learnerIdleDelaySeconds: 'SPORE_LEARNER_IDLE_DELAY_SECONDS',
  learnerBatchMinTurns: 'SPORE_LEARNER_BATCH_MIN_TURNS',
  learnerBatchMaxTurns: 'SPORE_LEARNER_BATCH_MAX_TURNS',
  learnerMinExchangeChars: 'SPORE_LEARNER_MIN_EXCHANGE_CHARS',
  learnerEnabledPlatforms: 'SPORE_LEARNER_ENABLED_PLATFORMS',
